...
AppVerName=Stellarium zh-TW Addons 0.1.6.1
AppVersion=0.1.6.1
...
SourceDir=.\
OutputDir=..\..\build
OutputBaseFilename=stellarium-zhTW-addon-0.1.6.1
Compression=lzma
...
Source: "stellarium.mo"; DestDir: "{app}\locale\zh_TW\LC_MESSAGES"; Components: touchinstallation
